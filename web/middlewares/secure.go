...
const (
	...
	CSPWhitelist = "piwik.cozycloud.cc *.tile.openstreetmap.org *.tile.osm.org *.tiles.mapbox.com api.mapbox.com www.wikidata.org query.wikidata.org www.omdbapi.com fr.wikipedia.org musicbrainz.org"
)
